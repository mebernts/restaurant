  ...
  methods: {
    ...
    getDish(){ 
            if(this.editTable == "Dishes"){
               axios.get(`https://localhost:5001/resturant/Getdish/${this.editId}`)
                .then(result => {
                ...
                axios.get(`https://localhost:5001/resturant/Getdrink/${this.editId}`)
                .then(result => {
                    this.editDish = result.data;
                    console.log(this.editId)
                    console.log(this.editDish)   
                ...
                axios.get(`https://localhost:5001/resturant/Getappertizer/${this.editId}`)
                .then(result => {
                    this.editDish = result.data;
                    console.log(this.editId)
                    console.log(this.editDish)   
         ...
         putDish(){
             if(this.editTable == "Dishes"){
               axios.put("https://localhost:5001/resturant/Putdish/", this.editDish)
                .catch((error) => {
                    console.log(error)
                    });
            }else if (this.editTable == "Drinks"){
                axios.put("https://localhost:5001/resturant/Putdrink/", this.editDish)
                .catch((error) => {
                    console.log(error)

                    });
            }else if (this.editTable == "Appertizer"){
                axios.put("https://localhost:5001/resturant/Putappertizer/", this.editDish)
                .catch((error) => {
                    console.log(error)
                    });
            }
